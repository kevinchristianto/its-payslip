...
function layout_change(layout) {
  ...
  const logoPaths = isDark ? '../assets/images/its-logo.png' : '../assets/images/its-logo.png';

  const landingLogoPath = isDark ? 'assets/images/its-logo.png' : 'assets/images/its-logo.png';
